...
/// <summary>
/// Inspector class used to edit UIPopupList2s.
/// </summary>

[CustomEditor(typeof(UIPopupList2))]
public class UIPopupList22Inspector : UIWidgetContainerEditor
{
	enum FontType
	{
		Bitmap,
