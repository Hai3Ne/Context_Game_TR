...
/// 保险箱
/// </summary>
public class UI_LK_Bank : UILayer {
    ...
    public void Login(string pwd) {
        GameConfig.InsurePassword = pwd;
        FishNetAPI.Instance.SendMainQueryInsureInfo(GameConfig.InsurePassword);
    }
