...
namespace Kubility
{
    public static class KTool
    {
        ...
        public static void LogTime(Stopwatch watch, string headstr = null)
        {
            watch.Stop();
            if (headstr == null)
                UnityEngine.Debug.Log("Cost Time =  " + watch.ElapsedMilliseconds.ToString() + " ms");
            else
                UnityEngine.Debug.Log(headstr + watch.ElapsedMilliseconds.ToString() + " ms");
        }
        ...
        public static void DumpTime(VoidDelegate dv)
        {
            ...
            watch.Stop();
            UnityEngine.Debug.Log("Cost Time =  " + watch.ElapsedMilliseconds.ToString() + " ms");
            UnityEngine.Debug.Log("Cost Time Span =  " + watch.Elapsed.ToString());
        }
        ...
        public static void Dump(object obj)
        {
            ...
            for (int i = 0; i < fields.Length; ++i)
            {
                ...
                UnityEngine.Debug.Log("FieldInfo Name =" + info.Name + " Type = + " + info.FieldType.ToString() + " Value =" + info.GetValue(obj));
            }

            for (int i = 0; i < propertys.Length; ++i)
            {
                PropertyInfo info = propertys[i];
                UnityEngine.Debug.Log("PropertyInfo Name =" + info.Name + " Type = + " + info.PropertyType.ToString() + " Value =" + info.GetValue(obj, null));
            }
