...
public class BladeMaster : MonoBehaviour
{
	...
	protected void Initialise ()
	{
		...
		//
		mAnim["Attack1"].speed = 2.0f;
		mAnim["Attack2"].speed = 2.0f;		
		//
		//
		animationAttack1Anticipation = mAnim["Attack1Anticipation"];
		animationAttack1 = mAnim["Attack1"];
		//
		animationAttack2Anticipation = mAnim["Attack2Anticipation"];
		animationAttack2 = mAnim["Attack2"];
		animationAttack3 = mAnim["WhirlwindAttack"];
		//		
		animationWhirlwind = mAnim["Whirlwind"];		
		animationIdle = mAnim["Idle"];		
		animationIdle.speed = 0.4f;		
		animationRespawn = mAnim["Resurection"];
