...
public class AnimationController : MonoBehaviour
{
	...
	void Awake ()
	{
		...
		//
		mAnim.playAutomatically = false; // ** The Animation component must not be conflicting with the AnimationController
		mAnim.Stop(); 
	}
	void Start(){
		mAnim.Stop(); // ** The Animation component must not be conflicting with the AnimationController
	}
	//
