...
public class MUILocalize : MonoBehaviour
{
	/// <summary>
	/// Localization key.
	/// </summary>
	...
	void OnLocalize (MLocalization loc) { if (mLanguage != loc.currentLanguage) Localize(); }

	/// <summary>
	/// Localize the widget on enable, but only if it has been started already.
	/// </summary>

	void OnEnable() { if (mStarted && MLocalization.Instance != null) Localize(); }
	...
	{
		mStarted = true;
		if (MLocalization.Instance != null) Localize();
	}
	...
	{
		MLocalization loc = MLocalization.Instance;
