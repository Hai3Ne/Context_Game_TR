...
//来源：文本字间距 https://blog.csdn.net/qq_26999509/article/details/51902551 
...
public class TextSpacing : BaseMeshEffect
{
    ...
    public override void ModifyMesh(VertexHelper vh)
    {
        ...
        {
            vt = vertexs[i];
            vt.position += new Vector3(-_textSpacing * ((indexCount - i - 1) / 6), 0, 0);
            vertexs[i] = vt;
        }
        vh.Clear();
...
public class TextSpacing : BaseMeshEffect
{
    ...
    public override void ModifyMesh1(VertexHelper vh)
    { 
        if (!IsActive() || vh.currentVertCount == 0)
        {
            return;
