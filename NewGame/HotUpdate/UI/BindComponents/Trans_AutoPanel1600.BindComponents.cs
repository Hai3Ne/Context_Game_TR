...
namespace HotUpdate
{
	public partial class Trans_AutoPanel1600
	{
		private RectTransform m_Trans_AutoPanel1600;
		...
		private void GetBindComponents(GameObject go)
		{
			...
			m_Trans_AutoPanel1600 = autoBindTool.GetBindComponent<RectTransform>(0);
