...
namespace HotUpdate
{
    public partial class Trans_AutoPanel1500 : PanelBase
    {
        ...
        {
            m_Txt_GoldAuto.text =  ToolUtil.AbbreviateNumber(gold);
        }

        public void SetSingleGoldText(long gold)
        {
            m_Txt_SingleGoldAuto.text =ToolUtil.AbbreviateNumber(gold*10);
        }

        public void SetScore(long score)
        {
            m_Txt_ScoreAuto.text =  ToolUtil.AbbreviateNumber(score);
        }
    }
}
