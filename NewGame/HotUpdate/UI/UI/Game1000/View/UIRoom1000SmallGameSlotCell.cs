...
namespace HotUpdate
{
    ...
    public class UIRoom1000SmallGameSlotCell : UISlotCell
    {
        GameObject effect;
        ...
        public override void setElement(int ele, int row1 = 0)
        {
           ...
           // TxtGold.gameObject.SetActive(ele == SlotData_1000.specialelement);
        ...
        public override void onRollFinish()
        {
            ...
            //{
            //    GameObject go = CoreEntry.gGameObjPoolMgr.InstantiateEffect("UI/Prefabs/Game1000/FirstRes/Tb" + element);
