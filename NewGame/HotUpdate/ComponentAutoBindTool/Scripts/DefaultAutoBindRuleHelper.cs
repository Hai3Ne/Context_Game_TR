...
public class DefaultAutoBindRuleHelper : IAutoBindRuleHelper
{
    ...
    private Dictionary<string, string> m_PrefixesDict = new Dictionary<string, string>()
    {
        ...
        {"SRect","ScrollRect"},
        {"Drop","Dropdown"},
        {"Dragon","UnityArmatureComponent"},
        {"Spine","SkeletonGraphic"},
        {"LoopSRect","LoopVerticalScrollRect" },
        {"PageScroll","PageScrollView"},
        {"TMPInput","TMP_InputField" },
        {"VGridScroll","LoopGridView" },
        {"HGridScroll","LoopGridView" },
        {"Part","ParticleSystem" },
        {"Gold","GoldEffect" },
        {"Roll","RollJackPot" },
        {"Skele","SkeletonGraphic"},
        {"UIEvent","UIEventListener" },
        {"VGridScroll2" ,"LoopListView2"},
    };
