...
namespace SEZSJ
{
    ...
    public enum GameEvent
    {
        ...
        GE_LEAVEROLESCENE_TO_LOGIN,                  //从角色场景返回登入场景
        ...
        // event数量
        GE_Facebook_Login_Ret,    //facebook登陆返回
        GE_Facebook_Playing_Friends_Ret,    //facebook好友列表返回
        GE_Facebook_Invite_Friend_Ret,    //facebook好友邀请返回
        GE_Focus_Off,    //失去焦点
        GE_Focus_On,    //获得焦点

        GE_SC_TXDWKINFO_RET,    // 返回玩家玩咖相关信息
        GE_SC_TXDTTQINFO_RET,    // 返回玩家玩咖相关信息

        GE_CC_SENDSLOT,//发送滚动消息

        NUM_EVENTS,
        GE_TT_SENDMessage,//测试接口
        SubPackPross, //分包進度

        GE_EnterRoomRet500,                         //进入游戏500游戏房间信息
        GE_LeaveRoomRet500,                         //离开游戏500游戏房间结果
        GE_BetGameRet500,                         //500房间下注结果返回
        GE_RoomInfo500,                         //500房间下注结果返回
        Ge_BROADCAST_JACKPOT,                      //游戏中广播更新奖池
        Ge_BROADCAST_RefreshJACKPOT,                      //游戏中广播更新奖池

       

        GE_EnterRoomRet700,//700房间信息返回
        GE_BetGameRet700,//700房间信息返回
        GE_BroadCast_Jackpot700,//700房间信息返回
        GE_BroadCast_JackpotList700,//700房间信息返回
        GAME3_AWARD_BOX_700,// 领取宝箱奖励

        OnSlotState ,
        OnSlotWinGold,
        OnSlotFree ,
        OnSlotFreeEnd,
        OnSlotSpecialGameEnd,

        GE_LeaveGameRet,                                         //离开房间结果
        Ge_InGame_Connect,                      //房间重连
        GE_EndPause,
    ...
    public class EventParameter : CacheObject
    {
        ...
        public object msgParameter;         // 网络消息参数
        ...
        public static EventParameter Get(object msg)
        {
