...
namespace HotUpdate
{
    public partial class TourRankPanel : PanelBase
    {
        private string prefabName = "TourtRankItem";
        ...
        protected override void Awake()
        {
            ...
            TournamentModel.Instance.tourLevel = 1;
        ...
        private void Update()
        {
            ...
            if (m_Txt_CountTime != null)
                m_Txt_CountTime.text =TimeUtil.DateDiff( TimeUtil.TimestampToDataTime(ToolUtil.getServerTime()), TimeUtil.TimestampToDataTime(TournamentModel.Instance.nextTime));
        }
        ...
        private void OnCloseBtn()
        {
            ...
            MainPanelMgr.Instance.Close("TourRankPanel");
        }
