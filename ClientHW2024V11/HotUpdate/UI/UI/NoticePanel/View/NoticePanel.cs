...
namespace HotUpdate
{
    public partial class NoticePanel : PanelBase
    {
        private List<string> nociteContent = new List<string>
        {
            ...
            "尊敬的<炫彩突袭>玩家：\n近期发现有不法分子假冒<炫彩突袭>游戏工作人员骗取玩家财产，假意给玩家发送中奖信息进行诈骗行为，大致内容如下：主动联系玩家，告知玩家获得手机大奖并且私自添加联系方式，然后通过聊天平台引诱玩家付定金或者是打开钓鱼网址等诈骗手段，玩家因此损失了巨额钱财。为了避免您的财产受到损失，请注意以下几点:\n1、请勿相信非官方客服人员\n2、请勿线下进行交易转账\n3、请勿相信网上任何非官方的信息，例如: 折扣，返利、活动、外挂、加速器、中奖信息、中奖网址等\n4、私下交易得不到任何官方的保护，而且其中多是诈骗陷阱\n5、本游戏郑重承诺，游戏中无任何形式的金币提现和金币兑换现实货币的行为，国家明令禁止类似行为。如在游戏中发现任意相关的行为都是虚假的违法行为，并且肯定都不属于游戏制作方所为，请玩家仔细分辨，如发现任意相关行为请告知游戏客服进行举报\n参与上述违规交易的玩家，因此造成的损失，<炫彩突袭>将概不负责，同时我们再次提醒广大玩家务必提高自我保护意识，不要在游戏中轻信他人，多分辨言论的真实性，在公共场所上网要注意周围环境及账号安全。\n <炫彩突袭>运营团队",
            "尊敬的<炫彩突袭>玩家:\n在国家新闻出版署《关于防止未成年人沉迷网络游戏的通知》相关规定的基础上，为进一步加大未成年人的保护力度，将进行以下通告:禁止未成年人冒用成年人信息登录及游戏充值，如有类似行为一经查实，本游戏将拒绝退款。产生的投诉作为恶意投诉上报,望周知。再次感谢您对<炫彩突袭>的支持和关注，有了广大玩家的热切支持,相信<炫彩突袭>会做得更好,给玩家带来更多的乐趣和体验!如有任何问题,请联系客服。\n<炫彩突袭>运营团队"
        };
        Toggle[] toggles;
        bool bFirst = false;
