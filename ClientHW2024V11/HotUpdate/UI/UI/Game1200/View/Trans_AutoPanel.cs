...
namespace HotUpdate
{
    public partial class Trans_AutoPanel : PanelBase
    {
        ...
        {
            m_TxtM_GoldAuto.text = ToolUtil.GetCurrencySymbol()+"" + ToolUtil.ShowF2Num(gold);
        }

        public void SetSingleGoldText(long gold)
        {
            m_TxtM_SingleGoldAuto.text = ToolUtil.GetCurrencySymbol()+"" + ToolUtil.ShowF2Num(gold*10);
        }

        public void SetScore(long score)
        {
            m_TxtM_ScoreAuto.text = ToolUtil.GetCurrencySymbol()+"" + ToolUtil.ShowF2Num(score);
        }
    }
}
