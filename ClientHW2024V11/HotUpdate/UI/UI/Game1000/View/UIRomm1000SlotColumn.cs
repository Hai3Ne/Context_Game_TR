...
namespace HotUpdate
{
    public class UIRomm1000SlotColumn : UISlotColumn
    {
        ...
        {
            times = SlotData_1000.rollAccTimes;
            duration = SlotData_1000.rollAccTime;
        ...
        public override void onRollFinish()
        {
            ...
            {
                if (column == 4)
                    CoreEntry.gAudioMgr.PlayUISound(102);
            }
            else
                CoreEntry.gAudioMgr.PlayUISound(102);
        ...
        protected override void moveFinish()
        {
            ...
            { //最后一行
                ...
                if (true)
                {
                    //最后一下多个回弹效果
                    float from = startY - offsetY;
                    float to = from - slotCpt.heightCell /12;
                    if (tweenBounce == null)
                    {
        ...
        {
            base.reset();
            duration = SlotData_1000.rollTime;
        }
    }
}
