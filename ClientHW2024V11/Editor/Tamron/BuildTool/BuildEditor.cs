 ...
 *
 * Usage:
 *   Unity Editor → Tamron → Build Editor
 *
 * ============================================================================
 */
...
namespace SEZSJ
{
    public class BuildEditor : EditorWindow
    {
        ...
        #region Menu Item
        [MenuItem("Tamron/Product Build Editor", false)]
        ...
        private void DrawPackageSettingsSection()
        {
            ...
            GUILayout.Space(5);
            EditorGUILayout.BeginHorizontal();
            GUILayout.Label("KuaiShou ID:", GUILayout.Width(150));
            _turboId = EditorGUILayout.TextField(_turboId);
            EditorGUILayout.EndHorizontal();

            GUILayout.Space(5);
            EditorGUILayout.BeginHorizontal();
            GUILayout.Label("KuaiShou Name:", GUILayout.Width(150));
            _turboName = EditorGUILayout.TextField(_turboName);
            EditorGUILayout.EndHorizontal();

            GUILayout.Space(5);
            EditorGUILayout.BeginHorizontal();
            GUILayout.Label("Douyin ID:", GUILayout.Width(150));
