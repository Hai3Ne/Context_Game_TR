 ...
 *
 * Description:
 *   Unity Editor tool for importing and managing atlas textures.
 ...
 *
 * Usage:
 *   Unity Editor → Tools → Tamron Tool → Atlas Importer
 *
 * ============================================================================
 */
...
namespace SEZSJ
{
    public class AtlasImporterToolEnhance : EditorWindow
    {
        ...
        #region Menu Item
        [MenuItem("Tools/Tamron Tool/Atlas Importer", false)]
        static void OpenWindow()
        {
            var window = GetWindow<AtlasImporterToolEnhance>(true, "Atlas Importer Tool");
    ...
    public class AtlasPreviewWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            GUILayout.Label("ATLAS OUTPUT:", EditorStyles.boldLabel);
            GUILayout.Space(5);
            ...
            if (GUILayout.Button("CURRENT", GUILayout.Height(30)))
            {
