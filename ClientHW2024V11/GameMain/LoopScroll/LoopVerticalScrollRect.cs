...
namespace UnityEngine.UI
{
    ...
    public class LoopVerticalScrollRect : LoopScrollRect
    {
        ...
        protected override void Awake()
        {
            ...
            {
                SEZSJ.LogMgr.LogError("[LoopHorizontalScrollRect] unsupported GridLayoutGroup constraint");
            }
        }
        ...
        public void RefreshCellsIndex(int index)
        {
            Transform go = content.GetChild(index);
            if (scrollIndexFun != null)
            {
                scrollIndexFun(go, index);
            }
            go.SendMessage("ScrollCellIndex", index);
