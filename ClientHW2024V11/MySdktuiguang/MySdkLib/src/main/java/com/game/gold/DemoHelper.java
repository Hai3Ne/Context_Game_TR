...
public class DemoHelper implements IIdentifierListener {
    ...
    public static final String ASSET_FILE_NAME_CERT = "com.mxxxl.xxle.cert.pem"; // TODO （2）设置 asset证书文件名
    ...
    public void getDeviceIdsWithRequestPermission(Context cxt, boolean isGetOAID, boolean isGetVAID,
                                                  boolean isGetAAID) {
        // 获取当前isSupported状态
