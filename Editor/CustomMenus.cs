...
public class CustomMenus : MonoBehaviour {
	...
	[MenuItem("Tools/PC/基础资源打包(Build)")]
	static void BuildAssetBundlePC() {
	    ...
	    Debug.Log("开始打包PC assetbundle");
	    AssetBundlePacker.PrepareBuild(true, BuildTargetGroup.Standalone, BuildTarget.StandaloneWindows64, path);
	}
